...
public class BTSerialService {
     ...
     */
    public BTSerialService(Handler handler) {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        //
        Message msg = mHandler.obtainMessage(BTSerialModule.MESSAGE_CONNECT_OK);
        Bundle bundle = new Bundle();
        bundle.putString(BTSerialModule.KEY_DEVICENAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BTSerialModule.MESSAGE_CONNECT_FAIL);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(BTSerialModule.MESSAGE_CONNECT_LOST);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
                ...
                try {
                    ...
                    if (count > 0) {
                        ...
                        if (bytes > 0) {
                            ...
                            mHandler.obtainMessage(BTSerialModule.MESSAGE_READ, rawdata).sendToTarget();
                        }
                    }
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BTSerialModule.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
